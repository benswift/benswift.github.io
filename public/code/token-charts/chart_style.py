...
CONFIG = {
    ...
    "font": FONT,
    "axis": {
        "labelColor": INK2, "titleColor": INK2, "domainColor": GRID, "tickColor": GRID,
        "gridColor": GRID, "gridOpacity": 0.6, "labelFontSize": LABEL,
        "titleFontSize": LABEL, "titleFontWeight": "normal",
    },
    "legend": {"labelColor": INK, "titleColor": INK2, "labelFontSize": LABEL,
               "symbolType": "square", "symbolSize": 130},
    "title": {"color": INK, "fontSize": 19, "fontWeight": 600, "anchor": "start",
              "subtitleColor": INK2, "subtitleFontSize": LABEL, "subtitleLineHeight": 20,
              "offset": 12},
    "header": {"labelColor": INK, "labelFontSize": LABEL, "labelFontWeight": 600,
               "titleColor": INK2},
    "view": {"stroke": None},
}
