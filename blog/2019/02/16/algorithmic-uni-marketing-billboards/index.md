...
<div style="position:relative;padding-top:56.25%;">
  <iframe src="/widgets/algorithmic-ad-billboards.html" frameborder="0" allowfullscreen
    style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
</div>

If you want to see it in fullscreen, you can [do that as
well](/widgets/algorithmic-ad-billboards.html).

## How does it work?

It uses the same [reveal.js](https://github.com/hakimel/reveal.js/) template
that I use for all my [talks/slides](/talks/)---it's basically a one-slide presentation.
