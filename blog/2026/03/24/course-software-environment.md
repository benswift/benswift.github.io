...
For the [previous courses I've developed](TODO link to teaching page) I've
...
the [studio tutorial model](TODO link to core mechanic post) I _don't_ want to
...
written up as my [new stack of choice for software development](TODO link to
2026 Ben dev stack post), which is unsurprising given that I designed that new
...
TODO add links to project pages for all tools mentioned here.

- **terminal (ghostty) on the left**...
- running zellij as a multiplexer...
- which is managing multiple instances of Claude Code, Opencode etc. for coding,
  git for VCS, and helix for text editing, as well as other CLI/TUI tools as
  necessary
...
- recording the terminal with asciinema (the direct video feed of the screen
...
[^livecoding]:
    ...
    livecoding](TODO link to my livecoding page) sense.
