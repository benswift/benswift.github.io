...
summary:
  My pitch to be a Reimagine Fellow as part of the current reimagination project
  in CS/Engineering at the ANU.
---
...
🙌🥳🙌]({% link _posts/2019-08-30-Im-a-reimagine-fellow.md %})). And since the
...
gigs]({% link livecoding.md %})), in starting the
...
- a new code/creativity/culture major (at both undergraduate and masters level)
  ...
  [ANU School of Art & Design](http://soad.cass.anu.edu.au), and the
...
- a centre of excellence for digital arts/music/multimedia research, teaching
  ...
  [College of Arts & Social Sciences](http://cass.anu.edu.au))
...
Because of my [livecoding]({% link livecoding.md %}) I get asked to do outreach
stuff all the time (you're welcome, CECS marketing team 😉). I know why I get
asked: DJing with code is so _different_, it's a great hook for engaging folks
who might not have thought that combining code & musical creativity in that way
was possible.
...
> The
> [Embodied AudioVisual Interaction (EAVI)](http://eavi.goldsmithsdigital.com)
