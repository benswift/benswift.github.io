...
![bg right:45%](./assets/bg-producer.avif)
...
![bg right:45%](./assets/bg-problem.avif)
...
![bg right:45%](./assets/bg-events.avif)
...
![bg right:45%](./assets/bg-structure.avif)
