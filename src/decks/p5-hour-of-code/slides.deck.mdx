...
![bg right:45%](./assets/bg-crayon.avif)
...
![bg right:45%](./assets/bg-collaboration.avif)
...
![bg right:45%](./assets/bg-colours.avif)
...
![bg right:45%](./assets/bg-errors.avif)
...
![bg right:45%](./assets/bg-smiley.avif)
