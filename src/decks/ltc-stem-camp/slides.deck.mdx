...
![bg right:45%](./assets/bg-music.avif)
...
![bg right:45%](./assets/bg-patterns.avif)
...
![bg right:45%](./assets/bg-dimensions.avif)
...
![bg right:45%](./assets/bg-clock.avif)
