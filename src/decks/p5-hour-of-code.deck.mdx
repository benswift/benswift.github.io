...
description:
  A Telopea High School STEM Day workshop teaching kids to draw with p5.js ---
  computers, like 5-year-olds, need very specific instructions.
author: Ben Swift
date: "2017-09-06"
...
```
ReferenceError: sdfsd is not
  defined (line 8)
SyntaxError: missing ) after
  argument list (line 12)
```
