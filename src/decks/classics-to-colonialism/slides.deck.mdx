...
![bg right:45%](./assets/bg-euclid.avif)
...
![bg right:45%](./assets/bg-gcd.avif)
...
![bg right:45%](./assets/bg-domain.avif)
...
![bg right:45%](./assets/bg-bias.avif)
