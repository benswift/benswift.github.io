...
research takes a creative, experimental, and sometimes weird approach to AI and
large language models, spanning AI literacy pedagogy, human-scale AI artefacts,
and agentic AI development workflows. He's a Senior Lecturer at the ANU School
of Cybernetics, where he leads the _Cybernetic Studio_: a cybernetic community
that makes things out of hardware/software/people/stuff to explore cybernetic
systems/ideas and their impact on the world. He's also the creator
[LLMs Unplugged](https://llmsunplugged.org) and _COMP4020 Agentic Coding
Studio_, the ANU's flagship agentic software development course.
...
[LLMs Unplugged](https://llmsunplugged.org)---a hands-on workshop where learners
build language models with pen, paper, and dice, delivered to thousands of
participants from school students to senior government executives---and leads
Cybernetic Studio projects including the _Perceptron Apparatus_ (a wooden device
that performs neural network calculations by hand) and _PANIC!_ (an interactive
installation exploring how meaning transforms through feedback loops of
generative AI models). He's currently developing a new ANU course on agentic
coding: building software with LLM-based AI agents.
...
new ANU course on agentic coding that uses studio-style weekly critique sessions
to teach students how to build software with LLM-based AI agents.
