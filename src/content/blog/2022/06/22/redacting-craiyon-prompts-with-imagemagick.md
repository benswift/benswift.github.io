...
![Grid of AI image outputs generated in response to the prompt "redacting the prompt from a DALL-E image output with imagemagick"](./craiyon_2022-6-22_17-21-5.webp)

and the same output, after the redaction command has been run:

![Grid of AI image outputs generated in response to the prompt, which has been redacted](./redacted-craiyon_2022-6-22_17-21-5.webp)
