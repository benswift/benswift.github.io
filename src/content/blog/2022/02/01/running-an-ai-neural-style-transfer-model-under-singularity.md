...
description: "Getting a pytorch neural style transfer model running on RTX 3090s via
...
![Original ben.webp image](./headshot.webp)
![Original tiger.webp](./tiger.webp)

and here's the output:

![style-transferred ben-tiger.webp](./ben-tiger.webp)
