...
<Chart
  ...
  alt="A calendar heatmap of daily token use from July 2025 to August 2026, sparse and pale through 2025, dense and saturated from February 2026 onward"
/>
...
<Chart
  ...
  alt="Thirteen small-multiple area charts, one per model, where each model's daily token use rises and falls in turn as the next model replaces it"
/>
